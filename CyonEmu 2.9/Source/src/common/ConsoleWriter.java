...
public class ConsoleWriter implements Runnable{
	...
	{
		common.ConsoleWriter.println(msg, ConsoleColorEnum.GREEN);
	}
	public static void sendError(String msg)
	{
		common.ConsoleWriter.println(msg, ConsoleColorEnum.RED);
	}
	public static void sendEcho(String msg)
	{
		common.ConsoleWriter.println(msg, ConsoleColorEnum.BLUE);
	}

...
public class Compte {
	...
	public Compte(int aGUID,String aName,String aPass, String aPseudo,String aQuestion,String aReponse,int aGmLvl, int vip, boolean aBanned, String aLastIp, String aLastConnectionDate,String bank,int bankKamas, String friends, String enemy, int cadeau, int points)
	{
		this._GUID 		= aGUID;
		this._name 		= aName;
		this._pass		= aPass;
	...
	public void setCadeauID(int regalo) {
		_cadeau = regalo;
	}
	...
	public boolean recoverItem(int ligneID, int amount)
	{
		...
		if (_curPerso.addObjetSimiler(obj, true, -1)) {
			World.removeItem(obj.getGuid());
		} else {
			_curPerso.addObjet(obj);
			SocketManager.SEND_OAKO_PACKET(_gameThread.get_out(), obj);
		}
